# ModelSim script for tb_sobel_golden_fix testbench
vlib work
...
vsim -voptargs=+acc work.tb_sobel_golden_fix

add wave -radix hex /tb_sobel_golden_fix/*
add wave -radix hex /tb_sobel_golden_fix/dut/*
